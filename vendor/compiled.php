...
class Carbon extends DateTime
{
    ...
    public static function setLocale($locale)
    {
        ...
        static::translator()->addResource('array', require '/var/www/html/invoice/vendor/nesbot/carbon/src/Carbon' . '/Lang/' . $locale . '.php', $locale);
    }
...
class EventServiceProvider extends ServiceProvider
{
    protected $listen = array('App\\Events\\UserLoggedIn' => array('App\\Listeners\\HandleUserLoggedIn'), 'App\\Events\\UserSettingsChanged' => array('App\\Listeners\\HandleUserSettingsChanged'), 'App\\Events\\InvoiceSent' => array('App\\Listeners\\HandleInvoiceSent'), 'App\\Events\\InvoiceViewed' => array('App\\Listeners\\HandleInvoiceViewed'), 'App\\Events\\InvoicePaid' => array('App\\Listeners\\HandleInvoicePaid'), 'App\\Events\\QuoteApproved' => array('App\\Listeners\\HandleQuoteApproved'));
    public function boot(DispatcherContract $events)
    {
        parent::boot($events);
    }
